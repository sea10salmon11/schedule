...
# Использование: .\create_app.ps1 -AppName myapp -Package com.example.myapp
# =============================================================================
...
Write-Host ">>> Создаём Flutter приложение: $AppName ($Package)" -ForegroundColor Green
...
"@ | Set-Content android\app\build.gradle -Encoding UTF8
  ...
  build:
    ...
    - name: Upload APK
      ...
      with:
        ...
        retention-days: 30
"@ | Set-Content .github\workflows\main.yml -Encoding UTF8

# =============================================================================
# 9. main.dart — чистый стартовый экран
# =============================================================================
@"
...
Write-Host "ГОТОВО! Приложение '$AppName' создано." -ForegroundColor Green
Write-Host "=============================================" -ForegroundColor Green
Write-Host ""
Write-Host "Следующие шаги:"
Write-Host "  flutter pub get"
Write-Host "  flutter run                    # запуск на телефоне"
Write-Host "  flutter build apk --release    # сборка APK"
Write-Host ""
Write-Host "Версии конфигурации:" -ForegroundColor Cyan
